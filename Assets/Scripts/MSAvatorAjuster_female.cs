...
public class MSAvatorAjuster_female : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.V))
        {
            ...
            Avator.transform.localScale = new Vector3(Avator.transform.localScale.x*Camera.transform.localPosition.y/1.53f,
                                                      Avator.transform.localScale.y*Camera.transform.localPosition.y/1.53f,
                                                      Avator.transform.localScale.z);

            Debug.Log("アバタースケール:"+Camera.transform.localPosition.y/1.53f);
