...
public class RocketBoxArmIK : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        //armL.FixRoll(armL.forearm);
        //armL.FixRoll(armL.upperarm);
        //armL.FixRoll(armL.hand);
        //armR.FixRoll(armR.forearm);
        //armR.FixRoll(armR.upperarm);
        //armR.FixRoll(armR.hand);
    }
    ...
    class RocketBoxArm
    {
        ...
        public void FixRoll(Transform currentbone)
        {
